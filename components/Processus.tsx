...
const Processus = () => {
  return (
    <section className={cn("px-6 flex flex-col justify-center max-w-7xl mx-auto", /* "md:max-w-lg", */ "lg:px-0 lg:space-y-0 lg:grid lg:grid-cols-2 lg:items-start lg:justify-between")}>
      <div className={cn("px-6 space-y-6", "lg:sticky lg:top-24", "xl:px-0")}>
        ...
        <p className={cn("text-base text-center font-light w-full px-4", "lg:text-left lg:px-0 text-subtitle/80 lg:pb-2 lg:w-[500px]", "xl:text-lg xl:leading-relaxed")}>Un accompagnement et des étapes clés pour créer une boutique à votre image, prête à séduire vos clients.</p>
      ...
      <div className={cn('flex flex-col gap-4 pt-20 max-w-7xl', 'lg:py-0 lg:justify-end')}>
