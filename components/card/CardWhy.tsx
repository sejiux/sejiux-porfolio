    ...
    <div className={cn("w-full backdrop-blur-sm rounded-3xl flex flex-col gap-2 p-6 bg-gradient-to-b from-transparent via-transparent via-70% to-[#151518] border-b border-neutral-600/30", "lg:p-6")}>
      ...
      {lists.map((list, index) => (
        <div key={index} className={cn(
          ...
          "lg:mx-0", 
          index % 2 === 0 ?
            title === "Sejiux" ? "bg-gradient-to-r from-primary/50 via-transparent via-70% to-transparent" : "bg-gradient-to-r from-[#151518]/70 via-transparent via-70% to-transparent" : "bg-transparent"
        )}>
          <div> 
