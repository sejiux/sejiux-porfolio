...
const HeaderPage = () => {
  ...
  return (
    <header className={cn("min-h-[100dvh] flex relative flex-col justify-center gap-32 font-montserrat overflow-hidden")}>
        ...
        <div className={cn("flex flex-col justify-center items-center text-center flex-grow")}>
          <div className={cn("text-center space-y-10", "lg:max-w-4xl lg:mx-auto lg:space-y-10", "xl:max-w-full", "2xl:max-w-[1800px] 2xl:space-y-14")}>
                ...
                >
                  <AnimatedShinyText 
                    ...
                    <div className="flex gap-3 items-center">
                      <div className="border rounded-full border-neutral-700 p-1.5">
            ...
            <div className={cn("space-y-6 pb-4")}>
              ...
              )}>Boutiques Ecommerce<br className="hidden lg:block" /> Mémorables pour les Marques</h1>
              <p className={cn("text-base font-light w-full px-4", "lg:text-base lg:px-0 lg:mx-auto text-white/65 lg:pb-2 lg:w-[700px]", "xl:text-lg xl:leading-relaxed", "2xl:text-xl")}>je transforme votre vision en une expérience e-commerce mémorable qui marquera les esprits et captivera vos clients.</p>
            </div>
