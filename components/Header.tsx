...
const Header = () => {
  return (
    <header className={cn("h-screen flex relative flex-col justify-between px-6 font-montserrat overflow-hidden", "xl:px-10")}>
      <NavBar />
      ...
      <div className="md:hidden">
        <RadialGradient size={150} className="opacity-50" />
        <RadialGradient size={150} />
      </div>
      <MarqueeStack />
    </header>
  );
